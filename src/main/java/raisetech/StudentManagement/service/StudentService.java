...
public class StudentService {
    ...
    public List<StudentDetail> searchStudentList() {
        List<Student> studentList = repository.search();                        // ① 学生情報をDBから取得
        List<StudentCourse> studentsCoursesList = repository.searchStudentCoursesList(); // ② 学生のコース情報をDBから取得
        return converter.convertStudentDetails(studentList, studentsCoursesList);        // ③ まとめて返す
    }
